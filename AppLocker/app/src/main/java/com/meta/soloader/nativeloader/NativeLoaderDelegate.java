...
package com.meta.soloader.nativeloader;
...
public interface NativeLoaderDelegate {
  ...
  /** @see NativeLoader#loadLibrary(String, int) */
  boolean loadLibrary(String shortName, int flags);
  /** @see NativeLoader#getLibraryPath(String) */
  String getLibraryPath(String libName) throws IOException;
  /** @see NativeLoader#getSoSourcesVersion() */
