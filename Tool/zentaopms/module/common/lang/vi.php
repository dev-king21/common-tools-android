 ...
 * @package  ZenTaoPMS
 * @version  $Id: vi.php 5116 2013-07-12 06:37:48Z quocnho@gmail.com $
...
$lang->ipLimited       = "<html><head><meta http-equiv='Content-Type' content='text/html; charset=utf-8' /></head><body>Sorry, your current IP is restricted. PLease liên lạc quản trị của bạnister to grant your permissions.</body></html>";
$lang->unfold          = '+';
$lang->fold            = '-';
$lang->homepage        = 'Trang thiết lập';
...
$lang->select        = 'Chọn';
$lang->selectAll     = 'Tất cả';
$lang->selectReverse = 'Bỏ chọn';
...
$lang->searchObjects['testtask']    = 'Yêu cầu';
...
$lang->qa->menu->report    = array('link' => 'Báo cáo|testreport|browse|productID=%s', 'alias' => 'view,create,edit');
$lang->qa->menu->caselib   = array('link' => 'Thư viện tình huống|caselib|browse', 'alias' => 'create,createcase,view,edit,batchcreatecase,showimport');
...
$lang->bug->menu->report    = array('link' => 'Báo cáo|testreport|browse|productID=%s');
$lang->bug->menu->caselib   = array('link' => 'Thư viện tình huống|caselib|browse');
...
$lang->testcase->menu->report    = array('link' => 'Báo cáo|testreport|browse|productID=%s');
$lang->testcase->menu->caselib   = array('link' => 'Thư viện tình huống|caselib|browse');
...
$lang->testtask->menu->report    = array('link' => 'Báo cáo|testreport|browse|productID=%s');
$lang->testtask->menu->caselib   = array('link' => 'Thư viện tình huống|caselib|browse');
...
$lang->testsuite->menu->report    = array('link' => 'Báo cáo|testreport|browse|productID=%s');
$lang->testsuite->menu->caselib   = array('link' => 'Thư viện tình huống|caselib|browse');
...
$lang->testreport->menu->report    = array('link' => 'Báo cáo|testreport|browse|productID=%s', 'alias' => 'view,create,edit');
$lang->testreport->menu->caselib   = array('link' => 'Thư viện tình huống|caselib|browse');
...
$lang->admin->subMenu->dev->editor = array('link' => 'Sửa code|dev|editor');
$lang->admin->subMenu->dev->entry  = array('link' => 'Ứng dụng|entry|browse', 'subModule' => 'entry');
...
$lang->error->noData          = 'Không có dữ liệu.';
$lang->error->editedByOther   = 'This record might have been changed. Vui lòng refresh and try to edit again!';
$lang->error->tutorialData    = 'Không có data can be imported in tutorial mode. Vui lòng quit tutorial first!';
$lang->error->noCurlExt       = 'Không có Curl module installed';

/* Page info. */
$lang->pager = new stdclass();
$lang->pager->noRecord     = "Không có records.";
$lang->pager->digest       = "Tổng: <strong>%s</strong>. %s <strong>%s/%s</strong> &nbsp; ";
...
$lang->pager->totalCount   = "Tổng: <strong>{recTotal}</strong> items";
...
$lang->suhosinInfo     = "Warning! Data is reaching the limit. Vui lòng change <font color=red>sohusin.post.max_vars</font> and <font color=red>sohusin.request.max_vars</font> (set larger %s value) in php.ini, then save và khởi động lại Apache or php-fpm, or some data will not be saved.";
$lang->maxVarsInfo     = "Warning! Data is reaching the limit. Vui lòng change <font color=red>max_input_vars</font> (set larger %s value) in php.ini, then save và khởi động lại Apache or php-fpm, or some data will not be saved.";
$lang->pasteTextInfo   = "Paste the text here. Each line will be a title. ";
$lang->noticeImport    = "Imported data contains data that has already existed in system. Vui lòng confirm you actions on the date.";
$lang->importConfirm   = "Nhập";
...
$lang->datepicker->dpText->TEXT_PREV_YEAR   = 'Last năm';
$lang->datepicker->dpText->TEXT_PREV_MONTH  = 'Tháng trước';
$lang->datepicker->dpText->TEXT_PREV_WEEK   = 'Tuần trước';
$lang->datepicker->dpText->TEXT_YESTERDAY   = 'Hôm qua';
$lang->datepicker->dpText->TEXT_THIS_MONTH  = 'Tháng này';
$lang->datepicker->dpText->TEXT_THIS_WEEK   = 'Tuần này';
$lang->datepicker->dpText->TEXT_TODAY       = 'Hôm nay';
$lang->datepicker->dpText->TEXT_NEXT_YEAR   = 'Next năm';
$lang->datepicker->dpText->TEXT_NEXT_MONTH  = 'Next tháng';
$lang->datepicker->dpText->TEXT_CLOSE       = 'Đóng';
$lang->datepicker->dpText->TEXT_DATE        = '';
$lang->datepicker->dpText->TEXT_CHOOSE_DATE = 'Chọn Date';
...
$lang->scrum->subMenu->stakeholder = array('link' => 'Stakeholder|stakeholder|browse|', 'subModule' => 'stakeholder');
