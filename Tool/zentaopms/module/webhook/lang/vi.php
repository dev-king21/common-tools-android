...
$lang->webhook->note->execution = "Tất cả actions will trigger the hook if {$lang->execution->common} trống, or only actions of selected {$lang->execution->common} will trigger it.";
